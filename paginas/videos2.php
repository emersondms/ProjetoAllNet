<html>
	<head>
		<title>Vídeos com demonstrações do funcionamento da Pulseira Inteligente e de outros dispositivos | DMS InnovaTech</title>
		<meta charset="UTF-8">
		...
		<meta name="description" content="Aqui demonstramos atraves de video o funcionamento da pulseira inteligente em situacoes reais">
	...
	<body>
		...
		<div id="container_principal">
			...
			<div id="video_container">
				<video id="video_principal" width="480" height="300" poster="../imagens/smartband.png">
				...
				<p>Demonstração da pulseira inteligente</p>
			</div>
			...
			<div id="videos_direita">
				...
				<a href="videos3.php" title="Demonstração do carro que dirige SEM motorista">
					<video width="300" height="100" class="videos_direita" poster="../imagens/carro.jpg">
