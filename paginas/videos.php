<html>
	<head>
		<title>Vídeos com demonstrações do funcionamento do Google Glass e de outros dispositivos | DMS InnovaTech</title>
		<meta charset="UTF-8">
		...
		<meta name="description" content="Aqui demonstramos atraves de video o funcionamento do Google Glass em situacoes reais">
	...
	<body>
		...
		<div id="container_principal">
			...
			<div id="video_container">
				<video id="video_principal" width="480" height="300" poster="../imagens/googleglass.jpg">
				...
				<p>Demonstração do Google Glass</p>
			</div>
